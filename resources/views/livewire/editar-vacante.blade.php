    ...
    <div>
        ...
        accept="image/*"  
         ...
         @if (empty($imagenNueva))
            <div class="my-5 w-96">
                <x-label for="imagen" :value="__('Imagen Actual de la vacante')" />
                <img src="{{asset("storage/vacantes/" . $imagen)}}" alt="Imagen actual">
            </div>
         @else
            <div class="my-5 w-96">
                @if ($imagenNueva)
                    <x-label for="imagen" :value="__('Imagen Nueva de la vacante')" />
